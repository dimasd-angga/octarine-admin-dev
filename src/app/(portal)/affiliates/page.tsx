            ...
            return (
              <Group spacing="xs" noWrap>
                <Button
                  ...
                  color="green"
                  onClick={() =>
                    handleStatusChange(row.original.id, "approved")
                  }
                >
                  Approve
                </Button>
                <Button
                  ...
                  color="red"
                  onClick={() =>
                    handleStatusChange(row.original.id, "rejected")
                  }
                >
                  Reject
                </Button>
  ...
  return (
    <ScrollArea>
      <List
        ...
        headerButtons={<CreateButton> Create Affiliate </CreateButton>}
      >
