                          ...
                          >
                            <div className="tf-mini-cart-image">
                              <Image
                                className="lazyload"
                                alt=""
                                src={product.productVariantDto.imageUrl}
                                width={600}
                                height={800}
                              />
                            </div>
                              ...
                              <div className="mb_12 d-flex align-items-center justify-content-between flex-wrap gap-12">
                                <div className="text-title">
                                  <Link
                                    ...
                                    className="link text-line-clamp-1"
                                  >
                                    {product.productVariantDto.name}
                                  </Link>
                                </div>
                                <div
                                  className="text-button tf-btn-remove remove"
                                  onClick={() => removeProductFromCart(product.productVariantDto.productId)}
                                >
                                  Remove
                                </div>
                              </div>
                              <div className="d-flex align-items-center justify-content-between flex-wrap gap-12">
                                <div className="text-secondary-2">{product.productVariantDto.volume} ML</div>
                                <div className="text-button">
                                  {product.quantity} X
                                  IDR {product.productVariantDto.price?.toLocaleString()}
                                </div>
                              </div>
                            </div>
                          </div>
