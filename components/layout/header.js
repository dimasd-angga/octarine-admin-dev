...
export default function OctarineHeader() {
    ...
    <header id="header" className="header-default header-style-4">
      <div className="main-header">
        <div className="container">
          <div className="row wrapper-header align-items-center pb-0 pt-0">
            <div className="col-xl-2 col-md-4 col-6 text-center">
              <Link href={`/`} className="logo-header">
                <Image
                  alt="logo"
                  className="logo"
                  src="/images/logo/octarine-alt.svg"
                  width={184}
                  height={42}
                />
              </Link>
                ...
                {MENU.map((menu) => {
                  return (
                    <li className="categories-item">
                      <Link href={menu.path} className="text-uppercase">
                        {menu.label}
                      </Link>
                    </li>
                  );
